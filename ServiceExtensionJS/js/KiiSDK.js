...
(function() {
	...
	// Generated by CoffeeScript 1.6.2
		var KiiJQueryHttpRequest, KiiRequest, KiiTitaniumHttpRequest, KiiUtilities, KiiXMLHttpRequest, root, _Kii, _KiiSocialConnect, __bind = function(
				fn, me) {
			return function() {
		...
		root = ((typeof exports) !== "undefined") && (exports !== null) ? new Object()
				: this;
		 ...
		 * 
		 * This class must be initialized before any Kii SDK functions are
		 * performed. This class also allows the application to make some
		 * high-level user calls and access some application-wide data at any
		 * time using static methods.
		 */
		...
		root.Kii = (function() {
			 ...
			 * 
			 * @param String
			 *            appID The application ID found in your Kii developer
			 *            console
			 * @param String
			 *            appKey The application key found in your Kii developer
			 *            console
			 * @param KiiSite
			 *            site Can be one of the constants KiiSite.US,
			 *            KiiSite.JP or KiiSite.CN depending on your location.
			 * @example Kii.initializeWithSite("my-app-id", "my-app-key",
			 *          KiiSite.JP);
			 */

			Kii.initializeWithSite = function(appID, appKey, site) {
				_instance = new _Kii(appID, appKey, site);
				return root.Kii.logger("Initialized " + appID + ", " + appKey
						+ ", " + site);
			};
			 ...
			 *            appKey The application key found in your Kii developer
			 *            console
			 * @example Kii.initialize("my-app-id", "my-app-key");
			 */

			Kii.initialize = function(appID, appKey) {
				return root.Kii.initializeWithSite(appID, appKey,
						root.KiiSite.US);
			};
			 ...
			 * 
			 * @param String
			 *            bucketName The name of the bucket the app should
			 *            create/access
			...
			/**
			 * Creates a reference to a group with the given name and a list of
			 * default members
			 * 
			 * @param {String}
			 *            groupName An application-specific group name
			 * @param {Array}
			 *            members An array of KiiUser objects to add to the
			 *            group
			 * @returns {KiiGroup} A new KiiGroup reference
			...
			Kii.groupWithNameAndMembers = function(groupName, members) {
				return new root.KiiGroup.groupWithNameAndMembers(groupName,
						members);
			};
			...
			/**
			 * Authenticate as app admin. <br>
			 * <br>
			 * <b>This api call must not placed on code which can be accessed by
			 * browser. This api is intended to be used by server side code like
			 * Node.js. If you use this api in code accessible by browser, your
			 * application id and application secret could be stolen. Attacker
			 * will be act as appadmin and all the data in your application will
			 * be suffered. </b>
			 * 
			 * @param {String}
			 *            clientId assigned to your application.
			 * @param {String}
			 *            clientSecret assigned to your application.
			 * @param {Object}
			 *            callbacks The callback methods called when
			 *            authentication succeeded/failed.
			 * @param {Method}
			 *            callbacks.success The callback method called when
			 *            authentication succeeded.
			 * @param {Method}
			 *            callbacks.failure The callback method called when
			 *            authentication failed.
			 * @example Kii.authenticateAsAppAdmin("your client id", "your
			 *          client secret", { success: function(adminContext) { //
			 *          adminContext : KiiAppAdminContext instance // Operate
			 *          entities with adminContext. }, failure: function(error,
			 *          statusCode) { // Authentication failed. } );
			 */

			Kii.authenticateAsAppAdmin = function(clientId, clientSecret,
					callbacks) {
				var authCallbacks, request, _this = this;
		...
		root.KiiACL = (function() {
			...
			/**
			 * Get the list of active ACLs associated with this object from the
			 * server
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 *            callbacks.success The callback method to call on a
			 *            successful list request
			 * @param {Method}
			 *            callbacks.failure The callback method to call on a
			 *            failed list request
			 * @example var acl = . . .; // a KiiACL object acl.listACLEntries({
			 *          success: function(theACL, theEntries) { // do something },
			 * 
			 * failure: function(theACL, anErrorString) { // do something with
			 * the error response } });
			 */

			KiiACL.prototype.listACLEntries = function(callbacks) {
				var listCallbacks, request, _this = this;
							...
							for (key in data) {
								...
								for (_i = 0, _len = value.length; _i < _len; _i++) {
									...
									if (entity.groupID != null) {
										subject = _this
												._groupWithID(entity.groupID);
									} else if (entity.userID != null) {
										subject = _this
												._userWithID(entity.userID);
									}
									results.push(root.KiiACLEntry
											.entryWithSubject(subject, action));
								}
							}
							return callbacks.success(_thisACL, results);
						} else {
							return callbacks.failure(_thisACL,
									"Unable to retrieve ACL list");
						}
					},
					failure : function(error, statusCode) {
			 ...
			 * This does not explicitly grant any permissions, which should be
			 * done through the KiiACLEntry itself. This method simply adds the
			 * entry to the local ACL object so it can be saved to the server.
			 * 
			 * @param {KiiACLEntry}
			 *            entry The KiiACLEntry to add
			 * @example var aclEntry = . . .; // a KiiACLEntry object var acl = . . .; //
			...
			/**
			 * Remove a KiiACLEntry to the local object. This does not
			 * explicitly revoke any permissions, which should be done through
			 * the KiiACLEntry itself. This method simply removes the entry from
			 * the local ACL object and will not be saved to the server.
			 * 
			 * @param {KiiACLEntry}
			 *            entry The KiiACLEntry to remove
			 * @example var aclEntry = . . .; // a KiiACLEntry object var acl = . . .; //
			 *          a KiiACL object acl.removeACLEntry(aclEntry);
			 */
			...
			/**
			 * Save the list of ACLEntry objects associated with this ACL object
			 * to the server
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed save request
			 * @example var obj = . . .; // a KiiObject obj.save({ success:
			 *          function(theSavedACL) { // do something with the saved
			 *          acl },
			 * 
			 * failure: function(theACL, anErrorString) { // do something with
			 * the error response } });
			...
			KiiACL.prototype._saveItr = function(idx, callbacks) {
				var aclEntry, path, request, _errorStr, _this = this;

				_this = this;
				aclEntry = this._entries[idx];
				path = "" + (this.aclPath()) + "/"
						+ (aclEntry.getActionString()) + "/"
						+ (aclEntry.getEntityString());
				root.Kii.logger("Saving single @path: " + path);
				request = this._getRequest({
					path : path,
					withApp : true
				});
				request.setMethod(aclEntry.getGrant() === true ? "PUT"
						: "DELETE");
				_errorStr = null;
		...
		root.KiiACLEntry = (function() {
			 ...
			 * 
			 * @param {KiiACLAction}
			 *            value The action being permitted/restricted
			 * @throws {InvalidACLAction}
			 *             If the value is not one of the permitted values
			 */

			KiiACLEntry.prototype.setAction = function(value) {
				if (value >= root.KiiACLAction.KiiACLBucketActionCreateObjects
						&& value <= root.KiiACLAction.KiiACLObjectActionWrite) {
			 ...
			 * 
			 * @param {KiiUser|KiiGroup}
			 *            value The entity being permitted/restricted
			 * @throws {InvalidACLSubject}
			 *             If the value is not one of the permitted values
			 */

			KiiACLEntry.prototype.setSubject = function(value) {
				if (value instanceof root.KiiGroup
						|| value instanceof root.KiiUser
						|| value instanceof root.KiiAnyAuthenticatedUser
						|| value instanceof root.KiiAnonymousUser) {
			 ...
			 * 
			 * @param {Boolean}
			 *            value true if the action is permitted, false otherwise
			 * @throws {InvalidACLGrant}
			 ...
			 * 
			 * The entry will not be applied on the server until the KiiACL
			 * object is explicitly saved. This method simply returns a working
			 * KiiACLEntry with a specified subject and action.
			 * 
			 * @param
			 * {KiiGroup|KiiUser|KiiAnyAuthenticatedUser|KiiAnonymousUser}
			 * subject A KiiGroup or KiiUser object to which the action/grant is
			 * being applied
			 * @param {KiiACLAction}
			 *            action One of the specified KiiACLAction values the
		...
		root.KiiBucket = (function() {
			 ...
			 * <br>
			 * <br>
			 * The object will not be created on the server until the KiiObject
			 * is explicitly saved. This method simply returns an empty working
			 * KiiObject.
			 * 
			 * @returns {KiiObject} An empty KiiObject with no specific type
			 * @example var bucket = . . .; // a KiiBucket var object =
			 *          bucket.createObject();
			 */
			 ...
			 * The object will not be created on the server until the KiiObject
			 * is explicitly saved. This method simply returns an empty working
			 * KiiObject with a specified type. The type allows for better
			 * indexing and improved query results. It is recommended to use
			 * this method - but for lazy creation, the createObject method is
			 * also available.
			 * 
			 * @param String
			 ...
			 * @example var bucket = . . .; // a KiiBucket var object =
			 *          bucket.createObjectWithType("scores");
			 */
			 ...
			 * <br>
			 * <br>
			 * Any KiiACLEntry objects added or revoked from this ACL object
			 * will be appended to/removed from the server on ACL save.
			 * 
			 * @returns {KiiACL} A KiiACL object associated with this KiiObject
			 * @example var bucket = . . .; // a KiiBucket var acl =
			 *          bucket.acl();
			 */
			 ...
			 * <br>
			 * <br>
			 * The query will be executed against the server, returning a result
			 * set.
			 * 
			 * @param KiiQuery
			 ...
			 * @example var bucket = . . .; // a KiiBucket var queryObject = . . .; //
			 *          a KiiQuery
			 *  // define the callbacks (stored in a variable for
			 * reusability) var queryCallbacks = { success:
			 * function(queryPerformed, resultSet, nextQuery) { // do something
			 * with the results for(var i=0; i&lt;resultSet.length; i++) { // do
			 * something with the object // resultSet[i]; // could be KiiObject,
			 * KiiGroup, KiiUser, etc }
			 *  // if there are more results to be retrieved if(nextQuery !=
			 * null) {
			 *  // get them and repeat recursively until no results remain
			 * bucket.executeQuery(nextQuery, queryCallbacks); } },
			 * 
			 * failure: function(queryPerformed, anErrorString) { // do
			 * something with the error response } };
			 * 
			 * bucket.executeQuery(queryObject, queryCallbacks);
			 */

			KiiBucket.prototype.executeQuery = function(query, callbacks) {
				var clauseData, data, executeCallbacks, path, request, _this = this;
					...
					success : function(data, statusCode) {
						...
						if (statusCode < 300 && statusCode >= 200) {
							...
							for (_i = 0, _len = _ref.length; _i < _len; _i++) {
								result = _ref[_i];
								resultSet.push(_thisBucket
										.objectWithJSON(result));
							}
							if (data.nextPaginationKey != null) {
								nextQuery = new KiiQuery(query);
								nextQuery
										.setPaginationKey(data.nextPaginationKey);
							}
							if (callbacks != null) {
							...
							return callbacks.failure(query,
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed query request
			 * @example var bucket = . . .; // a KiiBucket bucket['delete']({
			 *          success: function(deletedBucket) { // do something with
			 *          the result },
			 * 
			 * failure: function(bucketToDelete, anErrorString) { // do
			 * something with the error response } });
			 */

			KiiBucket.prototype["delete"] = function(callbacks) {
				var executeCallbacks, request, _this = this;
			...
			function KiiBucket(bucketName, parent) {
				...
				this.createObjectWithType = __bind(this.createObjectWithType,
						this);
			...
			KiiBucket.prototype._generatePath = function() {
				...
				if (this._user != null) {
					path = "/users/" + (this._user.getUUID()) + "/buckets/"
							+ this._bucketName;
				} else if (this._group != null) {
					path = "/groups/" + (this._group.getUUID()) + "/buckets/"
							+ this._bucketName;
				} else {
		...
		root.KiiBucketAdmin = (function(_super) {
			...
			function KiiBucketAdmin(bucketName, parent, token) {
				...
				this.createObject = __bind(this.createObject, this);
				this._getRequest = __bind(this._getRequest, this);
				KiiBucketAdmin.__super__.constructor.call(this, bucketName,
						parent);
			...
			KiiBucketAdmin.prototype.createObjectWithType = function(type) {
				return root.KiiObjectAdmin.objectWithBucket(this, type,
						this._adminToken);
			};
		...
		root.KiiGroup = (function() {
			...
			function KiiGroup() {
				this._setOwnerFromContext = __bind(this._setOwnerFromContext,
						this);
				this._userWithID = __bind(this._userWithID, this);
				this._getRequest = __bind(this._getRequest, this);
			...
			/**
			 * Returns the owner of this group if this group holds the
			 * information of owner.
			 * 
			 * Group will holds the information of owner when "saving group on
			 * cloud" or "retrieving group info/owner from cloud". The cache
			 * will not be shared among the different instances of KiiGroup.
			 * <UL>
			 * <LI>This API will not access to server. To update the group
			 * owner information on cloud, please call {@link KiiGroup#refresh}
			 * or {@link KiiGroup#getOwner}. </LI>
			 * <LI>This API does not return all the properties of the owner. To
			 * get all owner properties, {@link KiiUser#refresh} is necessary.</LI>
			 * </UL>
			 * 
			 * @returns {KiiUser} KiiUser who owns this group, undefined if this
			 *          group doesn't hold the information of owner yet.
			 ...
			 * 
			 * @returns {String} A URI string based on the current group. null
			 *          if a URI couldn't be generated.
			 * @example var group = . . .; // a KiiGroup var uri =
			 *          group.objectURI();
			 */
			 ...
			 * 
			 * @param {String}
			 *            bucketName The name of the bucket the user should
			 *            create/access
			 * @returns {KiiBucket} A working KiiBucket object
			 * @example var group = . . .; // a KiiGroup var bucket =
			 *          group.bucketWithName("myBucket");
			 */
			 ...
			 * <br>
			 * <br>
			 * This method will NOT access the server immediately. You must call
			 * save to add the user on the server. This allows multiple users to
			 * be added/removed before calling save.
			 * 
			 * @param {KiiUser}
			 *            member The user to be added to the group
			 * @example var user = . . .; // a KiiUser var group = . . .; // a
			 *          KiiGroup group.addUser(user); group.save(callbacks);
			 */
			...
			KiiGroup.prototype.addUser = function(member) {
				...
				if (ndx >= 0) {
					return KiiUtilities.arrayRemove(this._removeMembers, ndx,
							ndx);
				}
			};
			 ...
			 * <br>
			 * This method will NOT access the server immediately. You must call
			 * save to remove the user on the server. This allows multiple users
			 * to be added/removed before calling save.
			 * 
			 * @param {KiiUser}
			 *            member The user to be added to the group
			 * @example var user = . . .; // a KiiUser var group = . . .; // a
			 *          KiiGroup group.removeUser(user); group.save(callbacks);
			 */
			...
			KiiGroup.prototype._addMember = function(member, callback) {
				var memberCallbacks, request, _this = this;

				_thisGroup = this;
				root.Kii.logger("Adding member " + (member.getUUID())
						+ " to group " + this._groupName);
				request = this._getRequest({
				...
				memberCallbacks = {
					success : function(data, statusCode) {
						...
						KiiUtilities.arrayRemove(_thisGroup._getAddMembers(),
								ndx, ndx);
			...
			KiiGroup.prototype._removeMember = function(member, callback) {
				var removeCallbacks, request, _this = this;

				_thisGroup = this;
				root.Kii.logger("Removing member " + (member.getUUID())
						+ " to group " + this._groupName);
				request = this._getRequest({
					path : "/groups/" + this._uuid + "/members/"
							+ (member.getUUID()),
				...
				removeCallbacks = {
					success : function(data, statusCode) {
						...
						KiiUtilities.arrayRemove(
								_thisGroup._getRemoveMembers(), ndx, ndx);
						return callback.success(_thisGroup);
					},
					failure : function(error, statusCode) {
						var ndx;
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed list request
			 * @example var group = . . .; // a KiiGroup group.getMemberList({
			 *          success: function(theGroup, memberList) { // do
			 *          something with the result for(var i=0;
			 *          i&lt;memberList.length; i++){ var u = memberList[i]; //
			 *          a KiiUser within the group } },
			 * 
			 * failure: function(theGroup, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiGroup.prototype.getMemberList = function(callbacks) {
				...
				_thisGroup = this;
				root.Kii.logger("Getting member list for group "
						+ this._groupName);
				request = this._getRequest({
					path : "/groups/" + this._uuid + "/members",
					withApp : true
				...
				request
						.setAccept("application/vnd.kii.MembersRetrievalResponse+json");
				listCallbacks = {
					success : function(data, statusCode) {
						...
						if (statusCode < 300 && statusCode >= 200) {
							...
							for (_i = 0, _len = members.length; _i < _len; _i++) {
								member = members[_i];
								memberList.push(_this
										._userWithID(member.userID));
							}
							if (callbacks != null) {
								return callbacks
										.success(_thisGroup, memberList);
							}
						} else if (callbacks != null) {
							return callbacks.failure(_thisGroup, member,
									"Unable to get member list of group");
						}
					},
					failure : function(error, statusCode) {
						if (callbacks != null) {
			 ...
			 * 
			 * @param {String}
			 *            newName A String of the desired group name
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 *            callbacks.success The callback method to call on a
			 ...
			 *          group.changeGroupName("myNewName", { success:
			 *          function(theRenamedGroup) { // do something with the
			 *          group },
			 * 
			 * failure: function(theGroup, anErrorString) { // do something with
			 * the error response } });
			...
			KiiGroup.prototype.changeGroupName = function(newName, callbacks) {
				var request, saveCallbacks, _this = this;
				...
				if (this._uuid != null) {
					...
					saveCallbacks = {
						success : function(data, statusCode) {
							if (statusCode < 300 && statusCode >= 200) {
								...
								return callbacks
										.failure(_thisGroup,
												"Unable to change group name - invalid response");
							}
						},
						failure : function(error, statusCode) {
							if (callbacks != null) {
					...
					return callbacks
							.failure(_thisGroup,
									"Invalid group. Save the group on the server before updating the name.");
				}
			};
			 ...
			 * <br>
			 * <br>
			 * If the group does not yet exist, it will be created. If the group
			 * already exists, the members that have changed will be updated
			 * accordingly. If the group already exists and there is no updates
			 * of members, it will allways succeed but does not execute update.
			 * To change the name of group, use {@link #changeGroupName}.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed save request
			 * @example var group = . . .; // a KiiGroup group.save({ success:
			 *          function(theSavedGroup) { // do something with the saved
			 *          group },
			 * 
			 * failure: function(theGroup, anErrorString) { // do something with
			 * the error response } });
			...
			KiiGroup.prototype.save = function(callbacks) {
				var data, request, saveCallbacks, _this = this;
				...
				if (this._uuid == null) {
					...
					request
							.setContentType("application/vnd.kii.GroupCreationRequest+json");
					request.setMethod("POST");
					data = {};
			 ...
			 * <br>
			 * <br>
			 * The group must exist on the server. Local data will be
			 * overwritten.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 * @example var group = . . .; // a KiiGroup group.refresh({
			 *          success: function(theRefreshedGroup) { // do something
			 *          with the refreshed group },
			 * 
			 * failure: function(theGroup, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiGroup.prototype.refresh = function(callbacks) {
				var refreshCallbacks, request, _this = this;
				...
				request
						.setAccept("application/vnd.kii.GroupRetrievalResponse+json");
				refreshCallbacks = {
					success : function(data, statusCode) {
			 ...
			 * @example var group = . . .; // a KiiGroup group['delete']({
			 *          success: function(theDeletedGroup) { // do something },
			 * 
			 * failure: function(theGroup, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiGroup.prototype["delete"] = function(callbacks) {
				var deleteCallbacks, request, _this = this;
				...
				deleteCallbacks = {
					success : function(data, statusCode) {
						if (statusCode < 300 && statusCode >= 200
							...
							return callbacks.failure(_thisGroup,
									"Unable to parse response");
						}
					},
					failure : function(error, statusCode) {
			 ...
			 * 
			 * This API does not return all the properties of the owner. To get
			 * all owner properties, {@link KiiUser#refresh} is necessary.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed add request
			 * @example var group = . . .; // a KiiGroup group.getOwner({
			 *          success: function(theGroup, theOwner) { // do something },
			 * 
			 * failure: function(theGroup, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiGroup.prototype.getOwner = function(callbacks) {
				...
				return this.refresh({
					success : function(group) {
						if (callbacks != null) {
							return callbacks.success(group, group
									.getCachedOwner());
						}
					},
			 ...
			 * 
			 * @param {String}
			 *            uri The URI of the group to be represented
			 * @returns {KiiGroup} A new KiiGroup with its parameters filled in
			 *          from the URI
			 * @throws {InvalidURIException}
			 *             If the URI given is invalid
			 * @example var group = new
			 *          KiiGroup.groupWithURI("kiicloud://myuri");
			 */
		...
		root.KiiObject = (function() {
			...
			KiiObject.prototype._getPath = function() {
				...
				if (this._bucket.getUser() != null) {
					path = "/users/" + (this._bucket.getUser().getUUID())
							+ "/buckets/" + (this._bucket.getBucketName())
							+ "/objects/";
				} else if (this._bucket.getGroup() != null) {
					path = "/groups/" + (this._bucket.getGroup().getUUID())
							+ "/buckets/" + (this._bucket.getBucketName())
							+ "/objects/";
				} else {
					path = "/buckets/" + (this._bucket.getBucketName())
							+ "/objects/";
				}
				if (this._uuid != null) {
					path += this._uuid;
			 ...
			 * object is of invalid type, it will return false and a KiiError
			 * will be thrown (quietly). Accepted types are any JSON-encodable
			 * objects. <br>
			 * <b>NOTE: Before involving floating point value, please consider
			 * using integer instead. For example, use percentage, permil, ppm,
			 * etc.</br></b> The reason is:
			 * <li>Will dramatically improve the performance of bucket query.</li>
			 * <li>Bucket query does not support the mixed result of integer
			 * and floating point. ex.) If you use same key for integer and
			 * floating point and inquire object with the integer value, objects
			 * which has floating point value with the key would not be
			 * evaluated in the query. (and vice versa)</li>
			 * 
			 * @param {String}
			 *            key The key to set. The key must not be a system key
			 *            (created, metadata, modified, type, uuid) or begin
			 *            with an underscore (_)
			 * @param {Object}
			 *            value The value to be set. Object must be of a
			 *            JSON-encodable type (Ex: dictionary, array, string,
			 *            number, etc)
			 * @example var obj = . . .; // a KiiObject obj.set("score", 4298);
			 */
			 ...
			 * @returns {Object} The object associated with the key. null if
			 *          none exists
			 * @example var obj = . . .; // a KiiObject var score =
			 *          obj.get("score");
			 */
			 ...
			 * @throws {String}
			 *             Specified kiiGeoPint is not an instance of
			 *             KiiGeoPoint.
			 */
			 ...
			 * 
			 * @param {String}
			 *            key The key of the geo point to retrieve.
			 * @returns {KiiGeoPoint} KiiGeoPoint tied to the key. null if null
			 *          exists.
			 */
			 ...
			 * 
			 * @returns {KiiACL} A KiiACL object associated with this KiiObject
			 * @example var obj = . . .; // a KiiObject var acl =
			 *          obj.objectACL();
			 */
			 ...
			 * 
			 * @returns {String} A URI string based on the current object. null
			 *          if a URI couldn't be generated.
			 * @example var obj = . . .; // a KiiObject var uri =
			 *          obj.objectURI();
			 */
			...
			KiiObject.prototype.objectURI = function() {
				...
				if ((this._bucket != null) && (this._uuid != null)) {
					...
					uri += "buckets/" + (this._bucket.getBucketName())
							+ "/objects/" + this._uuid;
				}
				return uri;
			};
			...
			KiiObject.prototype._updateWithJSON = function(json) {
				...
				for (key in json) {
					...
					} else if (key === "createdAt" || key === "_created"
							|| key === "created") {
						_results.push(this._created = val);
					} else if (key === "modifiedAt" || key === "_modified"
							|| key === "modified") {
			...
			KiiObject.prototype._performSave = function(allFields, callbacks) {
				var data, key, path, request, saveCallbacks, _i, _len, _ref, _this = this;
				...
				if (this._objectType != null) {
					request.setContentType("application/vnd."
							+ (root.Kii.getAppID()) + "." + this._objectType
							+ "+json");
				}
				...
				saveCallbacks = {
					success : function(data, statusCode) {
						if (statusCode < 300 && statusCode >= 200) {
							...
							return callbacks.failure(_thisObject,
									"Unable to parse response");
						}
					},
					failure : function(error, statusCode) {
			 ...
			 * <br>
			 * <br>
			 * If the object does not yet exist, it will be created. If the
			 * object already exists, all fields will be removed or changed to
			 * match the local values.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed save request
			 * @example var obj = . . .; // a KiiObject obj.saveAllFields({
			 *          success: function(theSavedObject) { // do something with
			 *          the saved object },
			 * 
			 * failure: function(theObject, anErrorString) { // do something
			 ...
			 * <br>
			 * If the object does not yet exist, it will be created. If the
			 * object already exists, the fields that have changed will be
			 * updated accordingly.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            failed save request
			 * @example var obj = . . .; // a KiiObject obj.save({ success:
			 *          function(theSavedObject) { // do something with the
			 *          saved object },
			 * 
			 * failure: function(theObject, anErrorString) { // do something
			 * with the error response } });
			 ...
			 * <br>
			 * <br>
			 * The object must exist on the server. Local data will be
			 * overwritten.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed refresh request
			 * @example var obj = . . .; // a KiiObject obj.refresh({ success:
			 *          function(theRefreshedObject) { // do something with the
			 *          refreshed object },
			 * 
			 * failure: function(theObject, anErrorString) { // do something
			 * with the error response } });
			...
			KiiObject.prototype.refresh = function(callbacks) {
				var path, refreshCallbacks, request, _this = this;
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed delete request
			 * @example var obj = . . .; // a KiiObject obj['delete']({ success:
			 *          function(theDeletedObject) { // do something },
			 * 
			 * failure: function(theObject, anErrorString) { // do something
			 * with the error response } });
			 */
			 ...
			 * 
			 * @param {String}
			 *            uri The URI of the object to be represented
			 * @returns {KiiObject} A new KiiObject with its parameters filled
			 *          in from the URI
			 * @throws {InvalidURIException}
			 *             If the URI is not in the proper format
			 * @example var group = new
			 *          KiiObject.objectWithURI("kiicloud://myuri");
			 */
			...
			KiiObject.objectWithURI = function(uri) {
				...
				if (compLength >= 4) {
					...
					bucket = new root.KiiBucket._bucketWithName(bucketName,
							subject);
			...
			/**
			 * Move KiiObject body from an object to another object. <br>
			 * This moving can be allowed under same application, across
			 * different scopes and source/target KiiObject have a read and
			 * write permission (READ_EXISTING_OBJECT and
			 * WRITE_EXISTING_OBJECT). <br>
			 * <br>
			 * If target KiiObject has a body, it will be overwritten.
			 * 
			 * @param {String}
			 *            targetObjectUri A KiiObject URI which KiiObject body
			 *            is moved to.
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 *            callbacks.success The callback method to call on a
			 *            successful move request
			 * @param {Method}
			 *            callbacks.failure The callback method to call on a
			 *            failed move request
			 * @example var sourceObject = ...; // Source KiiObject var
			 *          targetObject = ...; // Target KiiObject var
			 *          targetObjectUri = targetObject.objectURI();
			 *          sourceObject.moveBody(targetObjectUri, { success:
			 *          function(theSrcObject, theTgtObjectUri) { // Do
			...
			KiiObject.prototype.moveBody = function(targetObjectUri, callbacks) {
				var moveCallbacks, path, request, _sourceObject, _this = this;

				_sourceObject = this;
				if (targetObjectUri == null) {
					throw root
							.InvalidArgumentException('targetObjectUri is required');
				}
				if (_sourceObject.getUUID() == null) {
					throw root
							.InvalidArgumentException('Source object is not saved on the cloud');
				}
				...
				request.setMethod("POST");
				request
						.setContentType("application/vnd.kii.ObjectBodyMoveRequest+json");
				request.setData(this._parseObjectUri(targetObjectUri));
				moveCallbacks = {
					success : function(data, statusCode) {
						if (statusCode < 300 && statusCode >= 200
								&& (callbacks != null)) {
							return callbacks.success(_sourceObject,
									targetObjectUri);
						} else if (callbacks != null) {
							return callbacks
									.failure(_sourceObject, targetObjectUri,
											"Unable to parse response");
						}
					},
					failure : function(error, statusCode) {
						if (callbacks != null) {
							return callbacks.failure(_sourceObject,
									targetObjectUri, error);
						}
					}
				};
		...
		root.KiiQuery = (function() {
			...
			/**
			 * Create a KiiQuery object based on a KiiClause <br>
			 * <br>
			 * By passing null as the ���clause��� parameter, all objects can be
			 * retrieved.
			 * 
			 * @param clause
			 ...
			 * 
			 * @param {String}
			 *            field The key that should be used to sort
			 */
		...
		root.KiiClause = (function() {
			...
			/**
			 * Create a KiiClause with the AND operator concatenating multiple
			 * KiiClause objects
			 * 
			 * @param {List}
			 *            A variable-length list of KiiClause objects to
			 *            concatenate
			 * @example KiiClause clause = KiiClause.and(clause1, clause2,
			 *          clause3, . . .)
			 */
			...
			/**
			 * Create a KiiClause with the OR operator concatenating multiple
			 * KiiClause objects
			 * 
			 * @param {List}
			 *            A variable-length list of KiiClause objects to
			 *            concatenate
			 * @example KiiClause clause = KiiClause.or(clause1, clause2,
			 *          clause3, . . .)
			 */
			...
			KiiClause.notEquals = function(key, value) {
				...
				return root.KiiClause.createWithWhere("not", [ root.KiiClause
						.equals(key, value) ]);
			};
			 ...
			 * @param {KiiGeoPoint}
			 *            center Geo point which specify center of the circle.
			 * @param {Number}
			 *            radius Radius of the circle. unit is meter. value
			 *            should be in range of ]0, 20000000]
			 * @param {String}
			 *            putDistanceInto Used for retrieve distance from the
			 *            center from the query result.Must match the pattern
			 *            "^[a-zA-Z_][a-zA-Z0-9_]*$". If the specified value is
			 *            null, query result will not contain the distance.
			 *            <b>Note:</b> You can get the results in ascending
			 *            order of distances from center. To do so, build the
			 *            orderBy field by "_calculated.{specified value of
			 *            putDistanceInto}" and pass it in
			 *            {@link KiiQuery#sortByAsc}. Note that, descending
			 *            order of distances is not supported. The unit of
			 *            distance is meter.
			 * @return {KiiClause} KiiClaluse reference.
			 * @throws {String}
			 *             <li> Specified key is not a string or an empty
			 *             string.</li>
			 *             <li>center is not an object of KiiGeoPoint.</li>
			 *             <li>putDistanceInto is not a string or an empty
			 *             string.</li>
			 * 
			 * @example var putDistanceInto = "distanceFromCurrentLoc"; var
			 *          currentLoc = ..; // current location var clause =
			 *          KiiClause.geoDistance("location", currentLoc, 4000,
			 *          putDistanceInto); var query =
			 *          KiiQuery.queryWithClause(clause); // Sort by distances
			 *          by ascending order.(Optional, use only if you intend to
			 *          retrieve the distances in a ascending order). var
			 *          orderByKey = "_calculated." + putDistanceInto;
			 *          query.sortByAsc(orderByKey); // Define the callbacks var
			 *          bucket = Kii.bucketWithName("MyBucket"); var
			 *          queryCallback = { success: function(queryPerformed,
			 *          resultSet, nextQuery) { // check the first object from
			 *          resultSet. var object = resultSet[0]; var point =
			 *          object.get("location"); var distanceToMyLocation =
			 *          object.get("_calculated")[putDistanceInto]; }, failure:
			 *          function(queryPerformed, anErrorString) { // do
			 *          something with the error response } };
			 *          bucket.executeQuery(query, queryCallback);
			 */

			KiiClause.geoDistance = function(key, center, radius,
					putDistanceInto) {
				...
				if (!isValidString(key)) {
					throw root
							.InvalidArgumentException("Specified key is not a string or is an empty string.");
				}
				if (!isValidGeoPoint(center)) {
					throw root
							.InvalidArgumentException("center is not a reference of KiiGeoPoint.");
				}
				pattern = "^[a-zA-Z_][a-zA-Z0-9_]*$";
				if ((putDistanceInto != null)
						&& !putDistanceInto.match(pattern)) {
					throw root
							.InvalidArgumentException("putDistanceInto is invalid.");
				}
			...
			/**
			 * Create a clause of geo box. This clause inquires objects in the
			 * specified rectangle. Rectangle would be placed parallel to the
			 * equator with specified coordinates of the corner.
			 * 
			 * @param {String}
			 *            key Key to inquire which holds geo point.
			 * @param {KiiGeoPoint}
			 *            northEast North-Eest corner of the rectangle.
			 * @param {KiiGeoPoint}
			 *            southWest South-Wast corner of the rectangle.
			 * @return {KiiClause} KiiClause reference.
			 * @throws {String}
			 *             <li> Specified key is not a string or is an empty
			 *             string.</li>
			 *             <li>northEast or southWest is not a reference of
			 *             KiiGeoPoint.</li>
			 */
			...
			KiiClause.geoBox = function(key, northEast, southWest) {
				...
				if (!isValidGeoPoint(northEast) || !isValidGeoPoint(southWest)) {
					throw root
							.InvalidArgumentException("northEast or southWest is not a reference of KiiGeoPoint.");
				}
				expression = new root.KiiClause();
				_dict = {};
				_dict.type = "geobox";
		...
		KiiRequest = (function() {
			...
			function KiiRequest(path, withApp) {
				...
				this._path = withApp ? "/apps/" + (root.Kii.getAppID()) + path
						: path;
				this._method = "GET";
				this._headers = {
					"accept" : "*/*"
			...
			KiiRequest.prototype.execute = function(callbacks, ignoreBody) {
				var h, json_text, key, name, postData, url, val, value, _ref, _ref1, _this = this;

				this._success = callbacks.success != null ? callbacks.success
						: this._success;
				this._failure = callbacks.failure != null ? callbacks.failure
						: this._failure;
				...
				root.Kii.logger("Making request[" + this._method + "] to "
						+ url + " with data: " + json_text);
				...
				this._headers['x-kii-sdk'] = root.KiiSDKClientInfo
						.getSDKClientInfo();
				...
				if (!this._anonymous && (root.KiiUser.getCurrentUser() != null)) {
					this._headers['Authorization'] = "Bearer "
							+ (root.KiiUser.getCurrentUser().getAccessToken());
				}
				...
				callbacks = {
					onComplete : function() {
						...
						if (xhr.readyState === 4) {
							if ((200 <= (_ref1 = xhr.status) && _ref1 < 400)) {
								root.Kii.logger("Completed Request["
										+ xhr.status + "]");
								...
								if (_this._ignoreBody) {
									...
									if (json != null) {
										if (json.errorCode != null) {
											...
											return _this._failure(errString,
													xhr.status, json.errorCode);
										} else {
											return _this._success(json,
													xhr.status);
										}
									} else {
										return _this._success(null, xhr.status,
								...
								errString = xhr.status + " : "
										+ root.Kii.getBaseURL() + _this._path;
								try {
									json = JSON
											.parse(decodeURIComponent(xhr.responseText));
								} catch (_error) {
									error = _error;
									json = null;
								}
					...
					onError : function() {
						...
						xhr = _this._httpRequest.xhr;
						root.Kii.logger('Error loading data...');
						errString = xhr.status + " : " + root.Kii.getBaseURL()
								+ _this._path;
						try {
							json = JSON
									.parse(decodeURIComponent(xhr.responseText));
				...
				this._httpRequest = this._createHttpRequest(this._method, url,
						callbacks);
				if (this._httpRequest.xhr == null) {
					this
							._failure(
									"Cross-Origin Resource Sharing is not supported by the browser.",
									0);
				}
				_ref1 = this._headers;
				for (key in _ref1) {
			...
			KiiRequest.prototype._createHttpRequest = function(method, url,
					callbacks) {
				var request;
				...
				if (root.Kii._getHttpRequestType() === null) {
					if (typeof jQuery !== 'undefined') {
						...
						request = new KiiJQueryHttpRequest(method, url,
								callbacks);
						...
						request = new KiiTitaniumHttpRequest(method, url,
								callbacks);
					}
				} else {
		...
		root.KiiUser = (function() {
			...
			function KiiUser() {
				...
				this.resendPhoneNumberVerification = __bind(
						this.resendPhoneNumberVerification, this);
				this.resendEmailVerification = __bind(
						this.resendEmailVerification, this);
				...
				this._authenticateWithToken = __bind(
						this._authenticateWithToken, this);
				...
				this._validateDisplayName = __bind(this._validateDisplayName,
						this);
			...
			/**
			 * Set the display name associated with this user. Cannot be used
			 * for logging a user in; is non-unique
			 * 
			 * @param {String}
			 *            value Must be between 4-50 alphanumeric characters,
			 ...
			 * 
			 * @param {String}
			 *            value The country code to set. Must be 2 alphabetic
			 *            characters. Ex: US, JP, CN
			...
			/**
			 * Get the status of the user's email verification. This field is
			 * assigned by the server
			 * 
			 * @returns {Boolean} true if the user's email address has been
			 *          verified by the user, false otherwise
			 */
			...
			/**
			 * Get the status of the user's phone number verification. This
			 * field is assigned by the server
			 * 
			 * @returns {Boolean} true if the user's email address has been
			 *          verified by the user, false otherwise
			 */
			...
			/**
			 * Get the access token for the user - only available if the user is
			 * currently logged in
			 * 
			 * @returns {String}
			 */
			...
			KiiUser.prototype._setAccessToken = function(_accessToken) {
				...
				return root.Kii.logger("Setting access token: "
						+ this._accessToken);
			};
			 ...
			 * 
			 * @returns {String} A URI string based on the given user. null if a
			 *          URI couldn't be generated.
			 * @example var user = . . .; // a KiiUser var uri =
			 *          user.objectURI();
			 */
			 ...
			 *            JSON-encodable type (Ex: dictionary, array, string,
			 *            number, etc)
			 * @example var user = . . .; // a KiiUser user.set("score", 4298);
			 */
			 ...
			 * @returns {Object} The object associated with the key. null if
			 *          none exists
			 * @example var user = . . .; // a KiiUser var score =
			 *          user.get("score");
			 */
			...
			/**
			 * Create a user object to prepare for registration with credentials
			 * pre-filled
			 * 
			 * <br>
			 * <br>
			 * Creates an pre-filled user object for manipulation. This user
			 * will not be authenticated until one of the authentication methods
			 * are called on it. It can be treated as any other KiiObject before
			 * it is authenticated.
			 * 
			 * @param username
			 *            The user's desired username. Must be between 3 and 64
			 *            characters, which can include alphanumeric characters
			 *            as well as underscores '_', dashes '-' and periods '.'
			 * @param password
			 *            The user's password. Must be between 4-50 characters,
			 *            made up of ascii characters excludes control
			 *            characters.
			 ...
			 * @example var user = KiiUser.userWithUsername("myusername",
			 *          "mypassword");
			 */
			 ...
			 * <br>
			 * <br>
			 * Creates an pre-filled user object for registration. This user
			 * will not be authenticated until the registration method is called
			 * on it. It can be treated as any other KiiUser before it is
			 * registered.
			 * 
			 * @param phoneNumber
			 *            The user's phone number
			 * @param password
			 *            The user's password. Must be at least 4 characters,
			 *            made up of alphanumeric and/or:
			 * @,#,$,%,^,&
			 * @throws {InvalidPasswordException}
			 *             If the password is not in the proper format
			 ...
			 * @returns a working KiiUser object
			 * @example var user = KiiUser.userWithPhoneNumber("+874012345678",
			 *          "mypassword");
			 */
			 ...
			 * @returns a working KiiUser object
			 * @example var user =
			 *          KiiUser.userWithPhoneNumberAndUsername("+874012345678",
			 *          "johndoe", "mypassword");
			 */

			KiiUser.userWithPhoneNumberAndUsername = function(phoneNumber,
					username, password) {
				var user;
			 ...
			 * @returns a working KiiUser object
			 * @example var user =
			 *          KiiUser.userWithEmailAddress("johndoe@example.com",
			 *          "mypassword");
			 */
			 ...
			 * @returns a working KiiUser object
			 * @example var user =
			 *          KiiUser.userWithEmailAddressAndUsername("johndoe@example.com",
			 *          "johndoe", "mypassword");
			 */

			KiiUser.userWithEmailAddressAndUsername = function(emailAddress,
					username, password) {
				var user;
			 ...
			 * @returns a working KiiUser object
			 * @example var user =
			 *          KiiUser.userWithEmailAddressAndPhoneNumber("johndoe@example.com",
			 *          "+874012345678", "mypassword");
			 */

			KiiUser.userWithEmailAddressAndPhoneNumber = function(emailAddress,
			 ...
			 * @returns a working KiiUser object
			 * @example var user =
			 *          KiiUser.userWithCredentials("johndoe@example.com",
			 *          "+874012345678", "johndoe", "mypassword");
			 */

			KiiUser.userWithCredentials = function(emailAddress, phoneNumber,
					username, password) {
				var user;
			 ...
			 * @param {String}
			 *            uri The URI of the object to be represented
			 * @returns {KiiUser} A new KiiUser with its parameters filled in
			 *          from the URI
			 * @throws {InvalidURIException}
			 *             If the URI is not in the proper format
			 ...
			 *            create/access
			 * @returns {KiiBucket} A working KiiBucket object
			 * @example var user = . . .; // a KiiUser var bucket =
			...
			KiiUser.prototype._authenticate = function(callbacks) {
				var authCallbacks, request, username, _this = this;
			...
			KiiUser.prototype._authenticateWithToken = function(token,
					callbacks) {
				var authCallbacks, request, _this = this;
			 ...
			 * 
			 * @param {String}
			 *            userIdentifier The username, validated email address,
			 *            or validated phone number of the user to authenticate
			 * @param {String}
			 ...
			 * @example KiiUser.authenticate("myusername", "mypassword", {
			 *          success: function(theAuthedUser) { // do something with
			 *          the authenticated user },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiUser.authenticate = function(userIdentifier, password, callbacks) {
				...
				try {
					...
					if (KiiUtilities._validateEmail(userIdentifier)) {
						user = root.KiiUser._userWithEmailAddress(
								userIdentifier, password);
					} else if (KiiUtilities
							._validatePhoneNumber(userIdentifier)) {
						user = root.KiiUser._userWithPhoneNumber(
								userIdentifier, password);
					} else if (KiiUtilities._validateUsername(userIdentifier)) {
						user = root.KiiUser.userWithUsername(userIdentifier,
								password);
					} else {
			...
			/**
			 * Asynchronously authenticates a user with the server using a valid
			 * access token
			 * 
			 * Authenticates a user with the server. This method is
			 * non-blocking.
			 * 
			 * @param {String}
			 *            accessToken A valid access token associated with the
			 *            desired user
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed authentication request
			 * @example KiiUser.authenticateWithToken("mytoken", { success:
			 *          function(theAuthedUser) { // do something with the
			 *          authenticated user },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 ...
			 * <br>
			 * <br>
			 * The user object must have an associated email/password
			 * combination.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 * @example var user = KiiUser.userWithUsername("myusername",
			 *          "mypassword"); user.register({ success:
			 *          function(theAuthedUser) { // do something with the
			 *          authenticated user },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			...
			KiiUser.prototype.register = function(callbacks) {
				var data, key, registrationCallbacks, request, value, _ref, _this = this;
				...
				request.setAnonymous(true);
				request
						.setContentType("application/vnd.kii.RegistrationRequest+json");
			 ...
			 * <br>
			 * <br>
			 * Update a user's password with the server. The fromPassword must
			 * be equal to the current password associated with the account in
			 * order to succeed.
			 * 
			 * @param {String}
			 *            fromPassword The user's current password
			 * @param {String}
			 *            toPassword The user's desired password. Must be at
			 *            least 4 characters, made up of alphanumeric and/or:
			 * @,#,$,%,^,&
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 *            callbacks.success The callback method to call on a
			 *            successful update password request
			 * @param {Method}
			 *            callbacks.failure The callback method to call on a
			 *            failed update password request
			 * @throws {InvalidPasswordException}
			 *             If the new password is not in the proper format
			 * @example var user = Kii.currentUser();
			 *          user.updatePassword("oldpassword", "newpassword", {
			 *          success: function(theUser) { // do something },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 */

			KiiUser.prototype.updatePassword = function(fromPassword,
					toPassword, callbacks) {
				var data, path, request, updateCallbacks, _this = this;

				_thisUser = this;
				root.Kii.logger("Updating password from " + fromPassword
						+ " to " + toPassword);
				if (KiiUtilities._validatePassword(toPassword)) {
					...
					request.setData(data);
					request
							.setContentType("application/vnd.kii.ChangePasswordRequest+json");
					updateCallbacks = {
						success : function(data, statusCode) {
							if (statusCode < 300 && statusCode >= 200) {
								...
								return callbacks.failure(_thisUser,
					...
					return callbacks.failure(_thisUser,
							(new root.InvalidPasswordException()).message);
				}
			};
			 ...
			 * <br>
			 * <br>
			 * Reset a user's password on the server. The user is determined by
			 * the specified userIdentifier - which is an email address that has
			 * already been associated with an account. Reset instructions will
			 * be sent to that identifier. <br>
			 * <br>
			 * <b>Please Note:</b> This will reset the user's access token, so
			 * if they are currently logged in - their session will no longer be
			 * valid.
			 * 
			 * @param {String}
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed update password request
			 * @example KiiUser.resetPassword("johndoe@example.com", { success:
			 *          function() { // do something },
			 * 
			 * failure: function(anErrorString) { // do something with the error
			 * response } });
			 */
			...
			KiiUser.resetPassword = function(userIdentifier, callbacks) {
				...
				root.Kii.logger("Resetting password with identifier: "
						+ userIdentifier);
				if (KiiUtilities._validateEmail(userIdentifier)) {
					accountType = "EMAIL";
				} else if (callbacks != null) {
					callbacks
							.failure("Invalid user identifier. Must be a valid email address");
					return;
				}
				if (accountType != null) {
					path = "/users/" + accountType + ":" + userIdentifier
			...
			KiiUser.prototype.verifyCredentials = function(type, code,
					callbacks) {
				var path, request, verifyCallbacks, _this = this;
				...
				request
						.setContentType("application/vnd.kii.AddressVerificationRequest+json");
				verifyCallbacks = {
					success : function(data, statusCode) {
						if (statusCode < 300 && statusCode >= 200) {
			 ...
			 * <br>
			 * <br>
			 * This method is used to verify the phone number of the currently
			 * logged in user.
			 * 
			 * @param {String}
			 *            verificationCode The code which verifies the currently
			 *            logged in user
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 ...
			 * @example var user = Kii.currentUser();
			 *          user.verifyPhoneNumber("012345", { success:
			 *          function(theUser) { // do something },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 */

			KiiUser.prototype.verifyPhoneNumber = function(verificationCode,
					callbacks) {
			...
			KiiUser.prototype.resendVerification = function(type, callbacks) {
				var path, request, resendCallbacks, _this = this;
			 ...
			 * <br>
			 * <br>
			 * This method will re-send the email verification to the currently
			 * logged in user
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 * @param {Method}
			 *            callbacks.failure The callback method to call on a
			 *            failed resend request
			 * @example var user = Kii.currentUser();
			 *          user.resendEmailVerification({ success:
			 *          function(theUser) { // do something },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 ...
			 * <br>
			 * <br>
			 * This method will re-send the SMS verification to the currently
			 * logged in user
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            failed resend request
			 * @example var user = Kii.currentUser();
			 *          user.resendPhoneNumberVerification({ success:
			 *          function(theUser) { // do something },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			...
			KiiUser.prototype.resendPhoneNumberVerification = function(
					callbacks) {
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed resend request
			 * @example var user = Kii.currentUser(); user.memberOfGroups({
			 *          success: function(theUser, groupList) { // do something
			 *          with the results for(var i=0; i&lt;groupList.length;
			 *          i++) { var g = groupList[i]; // a KiiGroup object } },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiUser.prototype.memberOfGroups = function(callbacks) {
				var memberCallbacks, path, request, _this = this;
				...
				request
						.setAccept("application/vnd.kii.GroupsRetrievalResponse+json");
				memberCallbacks = {
					success : function(data, statusCode) {
						...
						if (statusCode < 300 && statusCode >= 200) {
							...
							for (_i = 0, _len = _ref.length; _i < _len; _i++) {
								group = _ref[_i];
								groupList.push(root.KiiGroup
										._groupWithJSON(group));
							}
							if (callbacks != null) {
			 ...
			 * property from cloud, a {@link KiiGroup#refresh(callback)} is
			 * necessary.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed resend request
			 * @example var user = Kii.currentUser(); user.ownerOfGroups({
			 *          success: function(theUser, groupList) { // do something
			 *          with the results for(var i=0; i&lt;groupList.length;
			 *          i++) { var g = groupList[i]; // a KiiGroup object } },
			 * 
			...
			KiiUser.prototype.ownerOfGroups = function(callbacks) {
				...
				_thisUser = this;
				root.Kii.logger("Getting groups owned by the user "
						+ this._uuid);
			 ...
			 * 
			 * @param {String}
			 *            newPhoneNumber The new phone number to change to
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 * @param {Method}
			 *            callbacks.success The callback method to call on a
			 ...
			 *            failed resend request
			 * @example var user = Kii.currentUser();
			 *          user.changePhone('+19415551234', { success:
			 *          function(theUser) { // do something on success },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiUser.prototype.changePhone = function(newPhoneNumber, callbacks) {
				var path, request, updateCallbacks, _this = this;
				...
				request.setMethod("PUT");
				request
						.setContentType("application/vnd.kii.PhoneNumberModificationRequest+json");
				request.setData({
			 ...
			 *            failed resend request
			 * @example var user = Kii.currentUser();
			 *          user.changeEmail('mynewemail@kii.com', { success:
			 *          function(theUser) { // do something on success },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			...
			KiiUser.prototype.changeEmail = function(newEmail, callbacks) {
				...
				if (KiiUtilities._validateEmail(newEmail)) {
					...
					request.setMethod("PUT");
					request
							.setContentType("application/vnd.kii.EmailAddressModificationRequest+json");
					request.setData({
			 ...
			 * Otherwise, the fields that have changed will be updated
			 * accordingly.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            callbacks.failure The callback method to call on a
			 *            failed save request
			 * @example var user = Kii.getCurrentUser(); // a KiiUser
			 *          user.save({ success: function(theSavedUser) { // do
			 *          something with the saved user },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 */
			...
			KiiUser.prototype.save = function(callbacks) {
				...
				request.setMethod("POST");
				request
						.setContentType("application/vnd.kii.UserUpdateRequest+json");
				data = this._customInfo;
				if (this._country != null) {
					data.country = this._country;
				}
			 ...
			 * <br>
			 * <br>
			 * The user must exist on the server. Local data will be
			 * overwritten.
			 * 
			 * @param {Object}
			 *            callbacks An object with callback methods defined
			 ...
			 *            failed refresh request
			 * @example var user = Kii.getCurrentUser(); // a KiiUser
			 *          user.refresh({ success: function(theRefreshedUser) { //
			 ...
			 *            failed delete request
			 * @example var user = Kii.getCurrentUser(); // a KiiUser
			 *          user['delete']({ success: function(theDeletedUser) { //
			 *          do something },
			 * 
			 * failure: function(theUser, anErrorString) { // do something with
			 * the error response } });
			 ...
			 * 
			 * @example if(KiiUser.loggedIn()) { // do something }
			 */
			 ...
			 * 
			 * @example KiiUser.getCurrentUser();
			 */
				...
				for (key in json) {
					...
					if (key === "userID" || key === "id") {
						this._uuid = value;
							...
							|| key === "_created") {
						this._created = value;
					} else if (key === "modified" || key === "modifiedAt"
							|| key === "_modified") {
		...
		root.KiiSocialConnect = (function() {
			 ...
			 * 
			 * Set up the network. Need to be called before accessing other
			 * methods. <br>
			 * <b> Facebook </b> <table border="1" cellspacing="0"> <thead>
			 * <tr bgcolor="#CCCCFF">
			 * <th>Argument</th>
			 * <th>Value Type</th>
			 * <th>Value</th>
			 ...
			 * <td>For details refer to <a
			 * href="https://developers.facebook.com/docs/reference/javascript/">Facebook
			 * developer</a>.</td>
			 * </tr>
			 * </tbody> </table>
			 * 
			 * <br>
			 * <b> Twitter </b> <table border="1" cellspacing="0"> <thead>
			 * <tr bgcolor="#CCCCFF">
			 * <th>Argument</th>
			 * <th>Value Type</th>
			 * <th>Value</th>
			 ...
			 * </tbody> </table>
			 * 
			 * @param {KiiSocialNetworkName}
			 *            networkName One of the supported KiiSocialNetworkName
			 *            values
			 * @param {String}
			 *            apiKey The SDK key assigned by the social network
			 *            provider. For details refer to the table above.
			 * @param {String}
			 *            apiSecret The SDK secret assigned by the social
			 *            network provider. For details refer to the table
			 *            above.
			 * @param {Object}
			 *            extras Extra options that should be passed to the SNS.
			 *            For details refer to the table above.
			 * @throws {InvalidArgumentException}
			 *             For details refer to the table above
			 */

			KiiSocialConnect.setupNetwork = function(networkName, apiKey,
					apiSecret, extras) {
				var manager;
			 ...
			 * 
			 * This will initiate the login process for the given network. If
			 * user has already linked with the specified social network,
			 * sign-in with the social network. Otherwise, this will sign-up and
			 * create new user authenticated by the specified social network.
			 ...
			 * <td>If provided, KiiCloud uses this token while login using
			 * Facebook.</td>
			 * </tr>
			 * <tr>
			 * <td>permissions</td>
			 * <td>Object</td>
			 * <td>Object which has property named 'scope' and value is a
			 * string that is comma seperated list of permissions defined by
			 * facebook. ex) {scope: 'email,user_likes'} </td>
			 * <td>Facebook : <a
			 * href="http://developers.facebook.com/docs/authentication/permissions">Facebook
			 * permissions</a>. If omit, the app can only access the
			 * information of the users public profile. </td>
			 * </tr>
			 * </tbody> </table>
			 * 
			 * <br>
			 ...
			 * @param {Method}
			 *            callbacks.success The callback method to call on a
			 *            successful log in request
			 * @param {Method}
			 *            callbacks.failure The callback method to call on a
			 *            failed log in request
			 * @throws {InvalidArgumentException}
			 *             If access token or access token secret does not exist
			 *             or invalid(null or empty) in specified options.
			 * @example // Example of using no option
			 *          KiiSocialConnect.logIn(KiiSocialNetworkName.FACEBOOK,
			 *          null, {
			 * 
			 * success: function(user, network) { // do something now that the
			 * user is logged in },
			 * 
			 * failure: function(user, network, anErrorString) { // do something
			 * with the error response } });
			 */
			...
			KiiSocialConnect.logIn = function(networkName, options, callbacks) {
				...
				if (_instance != null) {
					...
					if (_instance._getManager(networkName)) {
						_instance._getManager(networkName)._logIn(options,
								callbacks);
						called = true;
					}
				}
			 ...
			 * 
			 * This will initiate the login process for the given network, which
			 * for SSO-enabled services like Facebook, will send the user to the
			 * Facebook site for authentication. There must be a currently
			 * authenticated KiiUser. Otherwise, you can use the logIn: method
			 * to create and log in a KiiUser using a network. The network must
			 * already be set up via setupNetwork
			 * 
			 * @param networkName
			 *            One of the supported KiiSocialNetworkName values
			 * @param options
			 *            A dictionary of key/values to pass to KiiSocialConnect
			 *            <br>
			 *            <b> Facebook </b> <table border="1" cellspacing="0">
			 *            <thead>
			 *            <tr bgcolor="#CCCCFF">
			 *            <th>Key</th>
			 *            <th>Value type</th>
			 ...
			 *            <td>String</td>
			 *            <td>Access token of Facebook.</td>
			 *            <td>If provided, KiiCloud uses this token while login
			 *            using Facebook.</td>
			 *            </tr>
			 *            <tr>
			 *            <td>permissions</td>
			 *            <td>Object</td>
			 *            <td>Object which has property named 'scope' and value
			 *            is a string that is comma seperated list of
			 *            permissions defined by facebook. ex) {scope:
			 *            'email,user_likes'} </td>
			 *            <td>Facebook : <a
			 *            href="http://developers.facebook.com/docs/authentication/permissions">Facebook
			 *            permissions</a>. If omit, the app can only access the
			...
			KiiSocialConnect.linkCurrentUserWithNetwork = function(networkName,
					options, callbacks) {
				var called;
				...
				if (_instance != null) {
					...
					root.Kii.logger(_instance._getManager(networkName));
					if (_instance._getManager(networkName)) {
						_instance._getManager(networkName)
								._linkWithCurrentUser(options, callbacks);
						called = true;
					}
				}
				root.Kii.logger("Callbacks");
			...
			KiiSocialConnect.unLinkCurrentUserFromNetwork = function(
					networkName, callbacks) {
				root.Kii.logger("Trying with instance");
				root.Kii.logger(_instance);
				if (_instance != null) {
					root.Kii.logger("And manager: ");
					root.Kii.logger(_instance._getManager(networkName));
					if (_instance._getManager(networkName)) {
						return _instance._getManager(networkName)
								._unlinkFromCurrentUser(callbacks);
					}
				} else if (callbacks != null) {
					return callbacks
							.failure(
			 ...
			 * The network must be set up and linked to the current user. It is
			 * recommended you save this to preferences for multi-session use.
			 * 
			 * @param networkName
			 *            One of the supported KiiSocialNetworkName values
			 * @returns {String} The current access token, null if unavailable
			 * @deprecated Use
			 *             {@link KiiSocialConnect.getAccessTokenObjectForNetwork}
			 *             instead.
			 */
			...
			/**
			 * Retrieve the current user's access token expiration date from a
			 * social network
			 * 
			 * The network must be set up and linked to the current user. It is
			 * recommended you save this to preferences for multi-session use.
			 ...
			 * @param networkName
			 *            One of the supported KiiSocialNetworkName values
			 * @returns {String} The current access token expiration date, null
			 *          if unavailable
			 * @deprecated Use
			 *             {@link KiiSocialConnect.getAccessTokenObjectForNetwork}
			 *             instead.
			...
			KiiSocialConnect.getAccessTokenExpirationForNetwork = function(
					networkName) {
				return _instance._getManager(networkName)._getTokenExpiration();
			};

			/**
			 * Retrieve the current user's access token object from a social
			 * network
			 * 
			 * The network must be set up and linked to the current user. It is
			 * recommended you save this to preferences for multi-session use.<br>
			 * <br>
			 * Following parameters can be assigned to object.<br>
			 * <br>
			 * <b>Facebook</b>
			 * <li>access_token</li>
			 * <li>expires_in</li>
			 ...
			 * @param networkName
			 *            One of the supported KiiSocialNetworkName values
			 * @returns {Object} tokenObject The current access token object,
			 *          null if unavailable.
			 */

			KiiSocialConnect.getAccessTokenObjectForNetwork = function(
					networkName) {
			...
			KiiSocialConnect.logOutAll = function() {
				...
				if (_instance != null) {
					fb = _instance
							._getManager(root.KiiSocialNetworkName.FACEBOOK);
					if (fb != null) {
						fb._logOut();
					}
					tw = _instance
							._getManager(root.KiiSocialNetworkName.TWITTER);
					if (tw != null) {
						return tw._logOut();
					}
				}
		...
		root.KiiSocialConnectNetwork = (function() {
			...
			KiiSocialConnectNetwork.prototype._setTokenExpiration = function(
					_tokenExpiration) {
			...
			KiiSocialConnectNetwork.prototype._setTokenObject = function(
					_tokenObject) {
			...
			KiiSocialConnectNetwork.prototype._setCallbacks = function(
					_callbacks) {
			...
			function KiiSocialConnectNetwork(_network) {
				...
				this._unlinkFromCurrentUser = __bind(
						this._unlinkFromCurrentUser, this);
				this._linkWithCurrentUser = __bind(this._linkWithCurrentUser,
						this);
				...
				this._getTokenExpiration = __bind(this._getTokenExpiration,
						this);
				this._setTokenExpiration = __bind(this._setTokenExpiration,
						this);
			...
			KiiSocialConnectNetwork.prototype._logIn = function(options,
					_callbacks) {
				this._callbacks = _callbacks;
			};
			...
			KiiSocialConnectNetwork.prototype._linkWithCurrentUser = function(
					options, _callbacks) {
				this._callbacks = _callbacks;
			};

			KiiSocialConnectNetwork.prototype._unlinkFromCurrentUser = function(
					_callbacks) {
				this._callbacks = _callbacks;
			};

			KiiSocialConnectNetwork.prototype._setup = function(_key, _secret,
					_extras) {
				this._key = _key;
				this._secret = _secret;
				this._extras = _extras;
		...
		root.KiiSCNFacebook = (function(_super) {
			...
			function KiiSCNFacebook() {
				...
				this._setup = __bind(this._setup, this);
				KiiSCNFacebook.__super__.constructor.call(this,
			...
			KiiSCNFacebook.prototype._setup = function(_key, _secret, _extras) {
				...
				this._secret = _secret;
				this._extras = _extras;
				KiiSCNFacebook.__super__._setup.call(this, this._key,
						this._secret, this._extras);
			...
			KiiSCNFacebook.prototype._register = function(token, expires) {
				var registrationCallbacks, request, _this = this;
				...
				request.setAnonymous(true);
				request
						.setContentType("application/vnd.kii.AuthTokenFacebookRequest+json");
				registrationCallbacks = {
					success : function(data) {
						...
						if (_this._callbacks != null) {
							return _this._callbacks.success(root.KiiUser
									.getCurrentUser(), _this._network);
						}
					},
					failure : function(error, statusCode) {
						if (_this._callbacks != null) {
							return _this._callbacks.failure(null,
									_this._network, error);
						}
					}
				};
				return request.execute(registrationCallbacks, false);
			...
			KiiSCNFacebook.prototype._link = function(token, expires) {
				var linkCallbacks, request, _this = this;
				...
				linkCallbacks = {
					...
					failure : function(error, statusCode) {
						if (_this._callbacks != null) {
							return _this._callbacks.failure(root.KiiUser
									.getCurrentUser(), _this._network, error);
						}
					}
				};
			...
			KiiSCNFacebook.prototype._unlink = function() {
				var request, unlinkCallbacks, _this = this;
			...
			KiiSCNFacebook.prototype._logIn = function(options, callbacks) {
				var fbcallback, scope, statusCallback, _this = this;
			...
			KiiSCNFacebook.prototype._linkWithCurrentUser = function(options,
					callbacks) {
				var fbcallback, scope, statusCallback, _this;

				KiiSCNFacebook.__super__._linkWithCurrentUser.call(this,
						options, callbacks);
				_this = this;
				fbcallback = function(response) {
					if (response.authResponse) {
						return _this._link(response.authResponse.accessToken,
								response.authResponse.expiresIn);
				...
				if (root.KiiUser.getCurrentUser() != null) {
					...
					return callbacks
							.failure("A KiiUser must be logged in before linking to Facebook");
				}
			};

			KiiSCNFacebook.prototype._unlinkFromCurrentUser = function(
					callbacks) {
				KiiSCNFacebook.__super__._unlinkFromCurrentUser.call(this,
						callbacks);
				if (root.KiiUser.getCurrentUser() != null) {
					return this._unlink();
				} else if (callbacks != null) {
					return callbacks
							.failure("A KiiUser must be logged in before unlinking from Facebook");
				}
			};
		...
		/**
		 * @class represents the app admin context <br>
		 *        <br>
		 *        <B>This class must not referred from code accessbile from
		 *        browser. This class is intended to be used by server side code
		 *        like Node.js. If you use this class in code accessible by
		 *        browser, your application id and application secret could be
		 *        stolen. Attacker will be act as appadmin and all the data in
		 *        your application will be suffered. </B> Application
		 *        administrator context. entities obtained from this class will
		 *        be manupulated by application admin.
		...
		root.KiiAppAdminContext = (function() {
			...
			/**
			 * Creates a reference to a bucket operated by app admin. <br>
			 * <br>
			 * The bucket will be created/accessed within this app's scope
			 * 
			 * @param String
			 ...
			 *          success: function(adminContext) { var bucket =
			 *          adminContext.bucketWithName("myBucket"); // KiiBucket
			 *          operation by app admin is available now. }, failure:
			 *          function(errorString, errorCode) { // auth failed. } });
			 */

			KiiAppAdminContext.prototype.bucketWithName = function(bucketName) {
				var adminBucket;

				adminBucket = new root.KiiBucketAdmin(bucketName, null,
						this._token);
				return adminBucket;
			};
			 ...
			 * @example Kii.authenticateAsAppAdmin("client-id", "client-secret", {
			 *          success: function(adminContext) { var group =
			 *          appAdmin.groupWithName("newGroup"); // KiiGroup
			 *          operation by app admin is available now. }, failure:
			 *          function(errorString, errorCode) { // auth failed. } });
			 */
			 ...
			 * @example Kii.authenticateAsAppAdmin("client-id", "client-secret", {
			 *          success: function(adminContext) { var user; user =
			 *          appAdmin.userWithID("userid"); // KiiUser operation by
			 *          app admin is available now. }, failure:
			 *          function(errorString, errorCode) { // auth failed. } });
			 */
			...
			KiiAppAdminContext.prototype._userWithLoginName = function(
					loginName, callbacks) {
				var refreshCallbacks, request, user, _this = this;
				...
				refreshCallbacks = {
					success : function(data, statusCode) {
						if (statusCode < 300 && statusCode >= 200) {
							...
							return callbacks
									.failure("Unable to parse response");
						}
					},
					failure : function(error, statusCode) {
						if (callbacks != null) {
			...
			KiiAppAdminContext.prototype._objectWithURI = function(objectUri) {
				...
				if (compLength >= 4) {
					...
					bucketName = components[bucketIndex];
					if (components[0] === "groups") {
						group = new root.KiiGroupAdmin._groupWithID(
								components[1], this._token);
					} else if (components[0] === "users") {
						user = root.KiiUserAdmin._userWithID(components[1],
								this._token);
					}
					subject = null;
					if (group != null) {
					...
					bucket = new root.KiiBucketAdmin(bucketName, subject,
							this._token);
					obj = bucket.createObject();
					obj._setUUID(components[compLength - 1]);
				} else {
		...
		root.KiiGroupAdmin = (function(_super) {
			...
			KiiGroupAdmin._groupWithName = function(groupName, adminContext) {
				return root.KiiGroupAdmin._groupWithNameAndMembers(groupName,
						null, adminContext);
			};

			KiiGroupAdmin._groupWithNameAndMembers = function(groupName,
					members, adminContext) {
				var group;
			...
			KiiGroupAdmin.prototype.bucketWithName = function(name) {
				...
				bucket = new root.KiiBucketAdmin(name, this, this._adminContext
						._getToken());
				return bucket;
			};
			...
			KiiGroupAdmin.prototype._userWithID = function(id) {
				...
				user = root.KiiUserAdmin._userWithID(id, this._adminContext
						._getToken());
				return user;
			};
		...
		root.KiiUserAdmin = (function(_super) {
			...
			KiiUserAdmin.prototype.bucketWithName = function(bucketName) {
				...
				return bucket = new root.KiiBucketAdmin(bucketName, this,
						this._adminContext._getToken());
			};
		...
		/**
		 * @class Represent an anonymous user for setting the ACL of an object.
		 *        This will include anyone using the application but have not
		 *        signed up or authenticated as registered user.
		 * 
		 * When retrieving ACL from an object, test for this class to determine
		 * the subject type.
		 * @example Example: if(acl.subject typeof KiiAnonymousUser) { // the
		 *          ACL is set for anonymous users }
		 * 
		...
		/**
		 * @class Represent any authenticated user for setting the ACL of an
		 *        object. This will include anyone using the application who has
		 *        registered and authenticated in the current session.
		 * 
		 * When retrieving ACL from an object, test for this class to determine
		 * the subject type. Example:
		 * 
		 * if(acl.subject typeof KiiAnyAuthenticatedUser) { // the ACL is set
		...
		root.KiiSDKClientInfo = (function() {
			...
			KiiSDKClientInfo.getSDKClientInfo = function() {
				if (KiiSDKClientInfo._clientInfo == null) {
					KiiSDKClientInfo._clientInfo = "sn=jss;sv="
							+ root.Kii.getSDKVersion();
				}
		...
		root.KiiSCNTwitter = (function(_super) {
			...
			function KiiSCNTwitter() {
				...
				this._register = __bind(this._register, this);
				this._setup = __bind(this._setup, this);
				KiiSCNTwitter.__super__.constructor.call(this,
						KiiSocialNetworkName.TWITTER);
			}
			...
			KiiSCNTwitter.prototype._setup = function(_key, _secret, _extras) {
				...
				this._secret = _secret;
				this._extras = _extras;
				return KiiSCNTwitter.__super__._setup.call(this, this._key,
						this._secret, this._extras);
			};

			KiiSCNTwitter.prototype._register = function(options, callbacks) {
				var data, registrationCallbacks, request, _this = this;
				...
				request.setAnonymous(true);
				request
						.setContentType("application/vnd.kii.AuthTokenTwitterRequest+json");
				registrationCallbacks = {
					success : function(data) {
						var tokenObject, user;
						...
						root.Kii.setCurrentUser(user);
						if (callbacks != null) {
							return callbacks.success(root.KiiUser
									.getCurrentUser(), _this._network);
						}
					},
					failure : function(error, statusCode) {
						if (callbacks != null) {
							return callbacks.failure(null, _this._network,
									error);
						}
					}
				};
			...
			KiiSCNTwitter.prototype._link = function(options, callbacks) {
				var data, linkCallbacks, request, _this = this;
				...
				linkCallbacks = {
					...
					failure : function(error, statusCode) {
						if (callbacks != null) {
							return callbacks.failure(root.KiiUser
									.getCurrentUser(), _this._network, error);
						}
					}
				};
			...
			KiiSCNTwitter.prototype._logIn = function(options, callbacks) {
				...
				if ((options == null)
					...
					throw root
							.InvalidArgumentException('Both options.oauth_token and options.oauth_token_secret are required');
				} else if (!options.oauth_token) {
					throw root
							.InvalidArgumentException('options.oauth_token is required');
				} else if (!options.oauth_token_secret) {
					throw root
							.InvalidArgumentException('options.oauth_token_secret is required');
				}
				if (root.KiiUser.getCurrentUser() != null) {
					root.KiiUser.logOut();
				}
			...
			KiiSCNTwitter.prototype._linkWithCurrentUser = function(options,
					callbacks) {
				_this = this;
				if (root.KiiUser.getCurrentUser() == null) {
					callbacks
							.failure(null, _this._network, "No user logged in");
					return;
				}
				if ((options == null)
						|| (!options.oauth_token && !options.oauth_token_secret)) {
		...
		root.KiiGeoPoint = (function() {
			function KiiGeoPoint(_latitude, _longitude) {
				...
				if (!inRange(-90, 90, _latitude)
						|| !inRange(-180, 180, _longitude)) {
					throw root
							.InvalidArgumentException("Specified latitide or longitude is invalid");
				}
			}
			 ...
			 * 
			 * @param {Number}
			 *            latitude Latitude of the point in degrees. Valid if
			 *            the value is greater than -90 degrees and less than
			 *            +90 degrees.
			 * @param {Number}
			 *            longitude Longitude of the point in degrees. Valid if
			 *            the value is greater than -180 degrees and less than
			 *            +180 degrees.
			 * @throws {String}
